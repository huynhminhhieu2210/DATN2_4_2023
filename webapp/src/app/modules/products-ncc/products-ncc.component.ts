...
@Component({
  selector: 'app-products-ncc',
  templateUrl: './products-ncc.component.html',
  styleUrls: ['./products-ncc.component.css']
})
export class ProductsNCCComponent extends ComponentBase implements OnInit {
  listProduct?: PRODUCT[];
  ...
  search(){
    ...
    filtera.supplieR_ID = this.getRouteParam('type');
    filtera.iS_ACTIVE = '1';
